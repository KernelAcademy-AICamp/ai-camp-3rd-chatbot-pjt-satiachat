# **GLP-1 사용자 대상 LLM API를 활용한 다이어트 보조 챗봇 SatiaChat 개발**
본 프로젝트는 OpenAI GPT-4o-mini와 LlamaIndex RAG 시스템을 활용하여 GLP-1 계열 비만치료제(위고비, 마운자로, 오젬픽 등) 사용자를 위한 **AI 기반 다이어트 코칭 플랫폼**을 개발합니다.
사용자의 식단 기록, 체중 변화, 약물 복용 데이터를 기반으로 **개인화된 식단 코칭, 약물 정보 Q&A, 복용 일정 관리** 등 핵심적인 건강 관리 기능을 제공하는 것을 목표로 합니다.

• Satia = Satiety(포만감) + AI
• 다이어트 관리 + 약물 복용 추적 + AI 개인화 코칭을 하나의 앱에서 제공

타겟 사용자:
• 체중 감량을 원하는 사람
• 위고비(Wegovy), 마운자로(Mounjaro), 오젬픽(Ozempic) 같은 비만 치료제 사용자
• 식단 관리가 필요한 사람
...
### **1.4 식단 기록 및 분석**
11,086개의 한국 음식 데이터베이스를 활용한 정확한 영양 분석입니다. - [전국통합식품영양성분정보(음식)표준데이터](https://www.data.go.kr/data/15100070/standard.do)
| 기능 | 설명 |
|------|------|
...
| ![김혜민](https://avatars.githubusercontent.com/u/156163982?v=4) | ![어현우](https://avatars.githubusercontent.com/u/156163982?v=4) |
| :--------------------------------------------------------------: | :--------------------------------------------------------------: |
|            [김혜민](https://github.com/HyeminKim-kr)             |            [어현우](https://github.com/EHW99)             |
